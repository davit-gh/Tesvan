...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Service Category Edit</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.service-categories.index') }}">Service Categories</a></li>
                        <li class="breadcrumb-item active">Service Category Edit</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="card card-primary">
        ...
        @endif
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.service-category.update') }}">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="serviceCategory">Category Name</label>
                    <input value="{{ $category->id }}" type="hidden" class="form-control" name="id">
                    <input value="{{ old('name',$category->name) }}" type="text" class="form-control" name="name" id="serviceCategory">
                </div>
                <div class="form-group">
