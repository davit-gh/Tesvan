        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="qa_txt_blocks">
                    <img class="bradius" style="max-height: 672px; object-fit: cover" width="100%" height="auto" src="{{ asset("uploads/images/educations/$post->id/$post->image") }}"/>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        @foreach($blog_interest as $key => $b)
                            <div class="col-md-12">
                                <div class="qa_txt_blocks">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img class="bradius" style="height: 100%; object-fit: cover;" width="100%" src="{{ asset("uploads/images/educations/$b->id/$b->image") }}" />
                                        </div>
                                        <div class="col-md-8">
