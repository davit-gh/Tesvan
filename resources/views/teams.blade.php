        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="team_member_row">
                    ...
                    <p class="hue_black pb-3">{{__("HR/Marketing Specialist")}}</p>
                    <div class="layer hue_royal"></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="team_member_row">
                    ...
                    <p class="hue_black pb-3">{{__("UI/UX Designer")}}</p>
                    <div class="layer hue_royal"></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="team_member_row">
                    ...
                    <p class="hue_black pb-3">{{__("QA Engineer")}}</p>
                    <div class="layer hue_royal"></div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="team_member_row">
                    ...
                    <p class="hue_black pb-3">{{__("Junior QA Engineer")}}</p>
                    <div class="layer hue_royal"></div>
                </div>
            </div>
            <div class="col-md-3">
